...
<div class="mmTableOwnElement">
  <div class="row" style="position:relative;">
    <div class="col-md-3 mmTableOwnElementRowFirstE"><?php echo $thisElemArr['text1']; ?></div>
    <div class="col-md-3"><?php echo $thisElemArr['text2']; ?></div>
    <div class="col-md-3"><?php echo $thisElemArr['text3']; ?></div>
    <div class="col-md-3 mmTableOwnElementRowLastE"><?php echo $thisElemArr['text4']; ?></div>
