...
$(document).ready(function() {
  ...
  $('#vFrontOrderManagerAdminButton').click(function() {
     
    showOrderAdminWindow();
  });
  ...
  //front admin new buttons in upload window//////////
  
$('.uploadTypeButtons').click(function(){
 
   
  $('.send').hide();
  
  $('.uploadTypeButtons').removeClass('active');
  ...
  $('#vFrontUploadFrm').attr('data-type',type);
 ...
 $('#showButton').fadeOut();
 $('input[name=setCrop]').click(function(){
