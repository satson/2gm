...
function saveElemOwnSettingUsersWindowNowJs(curSaveBtnObj) {
  ...
  $.ajax({
    type: "POST",
    url: "admin/frontAdmin/ajax_php/ajax.php",
    data: {_art: 'saveElemOwnSettingUsersWindowNow',_langConfig:$('.elementLangConfig').serializeArray(), VCMS_POST_LANG: $('body').attr('data-lang'), _isElemOwnElem: curSaveBtnObj.attr('data-art'), _curSiteElemId: curSaveBtnObj.attr('data-id'), _elemSettingDateAb: $('#vFrontOwnElemSettingDateAb').val(), _elemSettingTimeAb: $('#vFrontOwnElemSettingTimeAb').val(), _elemSettingDateBis: $('#vFrontOwnElemSettingDateBis').val(), _elemSettingTimeBis: $('#vFrontOwnElemSettingTimeBis').val(), _elemSettingElemOnline: $('#vFrontOwnElemSettingElemOnline').val(), _elemSettingDesktopShow: $('#vFrontOwnElemSettingDesktopShow').val(), _elemSettingTabletShow: $('#vFrontOwnElemSettingTabletShow').val(), _elemSettingMobileShow: $('#vFrontOwnElemSettingMobileShow').val(), _userOwnDataArr: $('.vFrontOwnElemSettingsWindowInInhaltEigen form').serializeArray()},
    success: function(data) {
