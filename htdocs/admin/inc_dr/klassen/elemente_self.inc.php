...
class cmsElementeSelf extends funktionsSammlung {
  ...
  private function buildElementTextfeld($siteElementArr, $elementArr) {
    ...
    $return .= '<div class="vSiteElemBoxInhalt">' . $curTextFromElem . '</div>';
    // *************************************************************************
  ...
  private function buildEmpfehlungsManagerEmpfehlerFormsNow() {
    ...
    $return .= '<input class="btn btn-default" type="submit" id="vFrontEmpfehlerFormsLiveHolderBtnSubmitSend" value="Stammkunden-Domain generieren" />';
  ...
  public function saveElemOwnSettingUsersWindowNow($curSiteElemId, $isElemOwnElem) {
    ...
    $sqlText = 'UPDATE vseitenelemente SET selemOwnConfig = "'.$this->dbDecode($curSettingDataJson).'" WHERE selemID = "'.$this->dbDecode($curSiteElemId).'"';
    return $this->dbAbfragen($sqlText);
  }
